const question =[
    {
        question : "Q1.png",
        answers : [
                {img : 'Q1A1.png ', correct: false},
                {text : "images/Q1A2.png", correct: false},
                {text : "images/Q1A3.png", correct: false},
                {text : "images/Q1A4.png", correct: true}
        ]
    },
...
function showQuestion(){
    ...
    questionElement.src = questionNumber + ") " + currentQuestion.question;
    currentQuestion.answers.forEach(answer => {
        const button = document.createElement("button");
        button.innerHTML = answer.img;
